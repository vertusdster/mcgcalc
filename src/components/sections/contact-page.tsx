      ...
      <div className="container max-w-2xl">
        ...
        <div className="mt-10 flex flex-col items-center gap-6 md:mt-16">
          <a
            ...
            className="flex items-center gap-3 rounded-2xl border border-border/50 bg-card px-8 py-6 shadow-sm transition-all hover:border-[#3b82f6]/40 dark:hover:border-[#60a5fa]/30 hover:shadow-md"
          >
            <Mail className="h-6 w-6 text-[#1d4ed8] dark:text-[#60a5fa]" />
            <span className="text-lg font-semibold">contact@mcgcalc.com</span>
          </a>
