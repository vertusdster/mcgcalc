          ...
          <div className="space-y-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex w-3/5 gap-2">
                ...
                <select
                  ...
                  className="h-12 w-24 rounded-r-xl border border-slate-200 dark:border-slate-800 bg-gradient-to-r from-[#1d4ed8] dark:from-slate-400 to-[#3b82f6] dark:to-slate-200 px-3 text-center text-base font-bold text-white dark:text-slate-900 outline-none"
                >
                  {UNITS.map((u) => (
            ...
            <div className="flex gap-3">
              <button
                ...
                className="h-10 rounded-xl bg-gradient-to-r from-[#1d4ed8] dark:from-slate-400 to-[#3b82f6] dark:to-slate-200 px-6 text-sm font-bold text-white dark:text-slate-900 transition-opacity hover:opacity-90"
              >
                CONVERT
              </button>
              <button
