...
> The following reflects dosing escalation patterns observed across multiple published rodent studies. It is not a clinical protocol.

Published preclinical research frequently employs graduated dosing schedules to assess dose-response relationships and tolerance. The pattern below synthesizes common escalation frameworks from the literature:

| Phase | Duration | Dose (µg/kg) | Frequency | Route | Notes |
|-------|----------|--------------|-----------|-------|-------|
| Acclimation | Week 1–2 | 10 µg/kg | Once daily | SC | Baseline tolerance assessment |
| Standard | Week 3–6 | 25–50 µg/kg | Once daily | SC | Most common dose range in published studies |
| Extended | Week 7–12 | 50–100 µg/kg | Once daily | SC | High-dose studies, no toxicity reported |
...
- No maximum tolerated dose (MTD) has been established — LD1 was not achieved in toxicity studies
